...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'gardenRows', 1, 10, 1).name('Garden Rows').onChange(this.scene.updateGardenRows.bind(this.scene));
        this.gui.add(this.scene, 'gardenCols', 1, 10, 1).name('Garden Columns').onChange(this.scene.updateGardenCols.bind(this.scene));
